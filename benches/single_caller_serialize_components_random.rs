...
#[bench]
fn serialize_components_random_date(b: &mut Bencher) {
...
#[bench]
fn serialize_components_random_time(b: &mut Bencher) {
...
#[bench]
fn serialize_components_random_date_time(b: &mut Bencher) {
...
#[bench]
fn serialize_components_random_date_time_offset(b: &mut Bencher) {
